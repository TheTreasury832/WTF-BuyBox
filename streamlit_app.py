...
with col2:
    if st.button("Join Buyer Network", key="hero_join"):
        st.session_state.show_qualification = True
        st.rerun()
with col4:
...
""", unsafe_allow_html=True)="background: var(--accent-color); color: white; width: 20px; height: 20px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 1rem; font-size: 0.7rem; font-weight: bold;">✓</div>
            ...
            <li style="display: flex; align-items: center; padding: 0.75rem 0; border-bottom: 1px solid #f3f4f6;">
                <div style="background: var(--accent-color); color: white; width: 20px; height: 20px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 1rem; font-size: 0.7rem; font-weight: bold;">✓</div>
                Standard buyer database (5K+ buyers)
            </li>
            <li style="display: flex; align-items: center; padding: 0.75rem 0; border-bottom: 1px solid #f3f4f6;">
                <div style="background: var(--accent-color); color: white; width: 20px; height: 20px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 1rem; font-size: 0.7rem; font-weight: bold;">✓</div>
                Basic deal analysis tools
            </li>
            <li style="display: flex; align-items: center; padding: 0.75rem 0; border-bottom: 1px solid #f3f4f6;">
                <div style="background: var(--accent-color); color: white; width: 20px; height: 20px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 1rem; font-size: 0.7rem; font-weight: bold;">✓</div>
                Email support
...
with col2:
    ...
    <div class="pricing-card featured">
        ...
        <ul style="text-align: left; margin: 1rem 0; list-style: none;">
            ...
            <li style="display: flex; align-items: center; padding: 0.75rem 0; border-bottom: 1px solid #f3f4f6;">
                <div style="background: var(--accent-color); color: white; width: 20px; height: 20px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 1rem; font-size: 0.7rem; font-weight: bold;">✓</div>
                Premium buyer network (15K+ buyers)
            </li>
            <li style="display: flex; align-items: center; padding: 0.75rem 0; border-bottom: 1px solid #f3f4f6;">
                <div style="background: var(--accent-color); color: white; width: 20px; height: 20px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 1rem; font-size: 0.7rem; font-weight: bold;">✓</div>
...
""", unsafe_allow_html=True) class="feature-icon">🎯</div>
            ...
            <div>
                ...
                <div style="margin-bottom: 2rem;">
                    <div style="display: flex; align-items: center; margin-bottom: 1rem; font-weight: 600; color: var(--dark-color);">
                        <div style="background: var(--accent-color); color: white; width: 24px; height: 24px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin-right: 1rem; font-size: 0.8rem; font-weight: bold;">✓</div>
